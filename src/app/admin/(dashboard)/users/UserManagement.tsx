...
import { AdminUser, ActionResult } from "@/lib/types";
...
type CreateAdminState = Awaited<ReturnType<typeof createAdminUser>>;
								...
								<CardContent className="pt-8 space-y-6">
									...
									<div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
										...
										<div className="space-y-2">
											...
											<select
												name="role"
												className="flex h-11 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background font-medium focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
											>
										...
										<td className="py-4 px-6">
											{u.avatar ? (
												<Image
													...
													width={40}
													height={40}
													className="w-10 h-10 rounded-full object-cover border shadow-sm mx-auto"
													alt={u.name}
													unoptimized
												/>
											) : (
