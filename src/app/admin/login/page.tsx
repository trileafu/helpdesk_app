    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/30 p-4 font-sans">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center space-y-2">
            <Link href="/" className="inline-flex items-center gap-2 text-2xl font-bold text-primary hover:opacity-90 transition-opacity">
        ...
        <Card className="shadow-2xl border-none ring-1 ring-border bg-white/80 backdrop-blur">
          <CardHeader className="text-center border-b bg-muted/10 pb-6 pt-8">
             ...
             <CardDescription>Secure access to your support dashboard</CardDescription>
          </CardHeader>
             ...
             <form action={formAction} className="space-y-5">
               <div className="space-y-1.5">
                   ...
                   <div className="relative group">
                       ...
                       <Input 
                            ...
                            id="email" 
                            required 
                            placeholder="admin@bonet.id" 
                            defaultValue="admin@bonet.id" 
               ...
               <div className="space-y-1.5">
                   <div className="flex justify-between items-center ml-1">
                       ...
                       <span className="text-[10px] text-muted-foreground cursor-help hover:text-primary underline transition-colors">Forgot password?</span>
                   </div>
                   <div className="relative group">
               ...
               <Button type="submit" className="w-full h-11 text-base font-bold shadow-lg shadow-primary/20 hover:shadow-primary/30 active:scale-[0.98] transition-all" disabled={isPending}>
                 {isPending ? (
          ...
          <div className="p-6 text-center border-t bg-muted/5">
             <p className="text-xs text-muted-foreground">
                &copy; {new Date().getFullYear()} PT Bonet Utama. All rights reserved.
             </p>
          </div>
        </Card>
        
        <div className="text-center">
            <Link href="/" className="text-xs font-medium text-muted-foreground hover:text-primary hover:underline transition-all">
