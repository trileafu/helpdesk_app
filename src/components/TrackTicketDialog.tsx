                ...
                <div className="bg-white">
                    <DialogHeader className="p-6 border-b bg-muted/5">
                        <div className="flex items-center gap-2">
                            ...
                            <DialogTitle className="text-xl font-bold">Track Ticket</DialogTitle>
                        </div>
                    </DialogHeader>
                    <form onSubmit={handleSearch} className="p-8 space-y-6">
                        <div className="space-y-3 text-left">
                            <label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-1">Reference Code</label>
                            <Input
                                type="text"
